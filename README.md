...
Seeded accounts: `owner` / `password123` (full access), `kasir1` / `kasir123` (cashier).
...
> Readymade credentials so you can try the system immediately. These are development/demo only —
> the passwords are intentionally simple and must be changed in production.

| Role | Username | Password | What you can do |
|---|---|---|---|
| **Owner** | `owner` | `password123` | Full access across all outlets: manage products, stock, staff, reports, and switch between outlets |
| **Cashier** | `kasir1` | `kasir123` | Cashier screen: ring up transactions and print receipts, locked to the seeded outlet |

**How to log in:** open `http://localhost:3000/login`, enter the username & password above, and press *Masuk*.

For a **Manager** account, create one via the Staff menu after logging in as the Owner.
